...
if(ex){var chips=[].slice.call(ex.querySelectorAll('.chip')),q=ex.querySelector('input[type=search]'),empty=ex.querySelector('[data-empty]'),cur={},list=ex.querySelector('.rows'),initial=list.innerHTML,index,request=0,pager=ex.querySelector('.pager'),base=ex.getAttribute('data-facet'),rising=ex.hasAttribute('data-rising');
